...
def coin_prices(watch_list):
    # Will print to screen, prices of coins on 'watch_list'
    # returns all prices
...
def get_historical_klines(symbol, interval, start_str, end_str=None):
    ...
    """
    # create the Binance client, no nede for api key
    client = Client("", "")
    ...
    while True:
        ...
        if symbol_existed:
            ...
            # update our start timestamp using the last value in the array and the interval timeframe
        ...
        # sleep aftr every 3rd call to be kind of the API
        if idx % 3 == 0:
            time.sleep(1)
...
def save_historic_klines_datafile(symbol, start, end, interval):
    ...
    klines = get_historical_klines(symbol, interval, start, end)
    # open a file with filename including symbol, interval and start and end converted date
    with open(
